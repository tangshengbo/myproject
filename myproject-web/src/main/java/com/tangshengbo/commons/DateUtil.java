...
public final class DateUtil {
   ...
   private static final  Log LOG = LogFactory.getLog(DateUtil.class);
     ...
     * @return
     */
    public static Date dsDayHour(Date date, Integer hours) {
        Calendar cal = Calendar.getInstance();
        cal.setTime(date);
     ...
     * @return
     */
    public static Date dsDayMinute(Date date, int minute) {
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
     ...
     * @return
     */
    public static Date dsDaySecond(Date date, int second) {
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
