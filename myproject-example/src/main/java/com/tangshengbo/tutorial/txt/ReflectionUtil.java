...
public class ReflectionUtil {
     ...
     * @return
     */
    public static Object getValueByType(String classType, Object column, TxtImportEntity entity) throws Exception {
        ...
        if ("class java.util.Date".equals(classType) || "class java.sql.Date".equals(classType)) {
            ...
            if (StringUtils.isEmpty(format)) {
                throw new TxtImportException("字段日期格式没有指定:" + entity.getField().getName());
            }
            return DateUtils.parseDate((String) column, new String[]{entity.getFormat()});
        }
